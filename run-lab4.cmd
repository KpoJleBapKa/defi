...
setlocal
chcp 65001 >nul
title Solovian - DeFi Laboratory 4
...
echo ========================================
echo   Solovian - DeFi Laboratory 4
echo ========================================
echo Node.js:
node.exe --version
echo npm:
...
echo [2/2] Running Uniswap V2 integration...
call npm.cmd run integrate
if errorlevel 1 goto command_error
echo.

echo ========================================
echo   DEX INTEGRATION PASSED
echo ========================================
goto finish
